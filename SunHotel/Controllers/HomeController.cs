    ...
    public class HomeController : Controller
    {
        ...
        public async  Task<IActionResult> Habitacion( int? id)
        {
             if (id == null)
                ...
                var fechasocupadas = await _HabitacionRepository.FechasOcupadas(cvm.IdTipoHabitacion);
        ...
        public async Task<IActionResult> Pago(PagoVM vms)
        {
            ...
            if (ModelState.IsValid)
            {
                if (TempData["VMX"] is string z)
                {
                    ...
                    await _reservaRepository.AddCustom(vm, adeddpago.IdPago);
